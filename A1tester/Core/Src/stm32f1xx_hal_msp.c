...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(GPIOC, VIN42_Pin|VIN25_Pin|Vin15_Pin);

    HAL_GPIO_DeInit(GPIOA, VIN28_Pin|VIN18_Pin|VIN30_Pin|VIN11_Pin);

    HAL_GPIO_DeInit(VIN178_GPIO_Port, VIN178_Pin);
